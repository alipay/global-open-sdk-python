...
class AlipayAuthApplyTokenResponse(AlipayResponse):
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "access_token_expiry_time")
            and self.access_token_expiry_time is not None
        ):
        ...
        if (
            hasattr(self, "refresh_token_expiry_time")
            and self.refresh_token_expiry_time is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayAuthApplyTokenResponse, self).parse_rsp_body(
            response_body
        )
