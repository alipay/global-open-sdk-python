...
class AlipayAcceptDisputeResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayAcceptDisputeResponse."""
    ...
    def dispute_resolution_time(self):
        """
        The time when you accept the dispute.  Note: This prameter is returned when the value of resultCode is SUCCESS.  More information:  Maximum length: 64 characters
        """
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "dispute_resolution_time")
            and self.dispute_resolution_time is not None
        ):
            params["disputeResolutionTime"] = self.dispute_resolution_time
        return params

    def parse_rsp_body(self, response_body):
        response_body = super(AlipayAcceptDisputeResponse, self).parse_rsp_body(
            response_body
        )
