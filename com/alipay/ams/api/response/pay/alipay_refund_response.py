...
class AlipayRefundResponse(AlipayResponse):
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "actual_refund_amount")
            and self.actual_refund_amount is not None
        ):
        ...
        if (
            hasattr(self, "refund_non_guarantee_coupon_amount")
            and self.refund_non_guarantee_coupon_amount is not None
        ):
            params["refundNonGuaranteeCouponAmount"] = (
                self.refund_non_guarantee_coupon_amount
            )
        if (
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "actualRefundAmount" in response_body:
            ...
            self.__actual_refund_amount.parse_rsp_body(
                response_body["actualRefundAmount"]
            )
        ...
        if "refundNonGuaranteeCouponAmount" in response_body:
            ...
            self.__refund_non_guarantee_coupon_amount.parse_rsp_body(
                response_body["refundNonGuaranteeCouponAmount"]
            )
