...
class AlipayInquireReleaseResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayInquireReleaseResponse.
    ...
    def release_request_id(self):
        """
        The request identifier originally used to create the release. Returned when result.resultStatus is S.
        """
    ...
    def release_amount(self):
        """Gets the release_amount of this AlipayInquireReleaseResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayInquireReleaseResponse, self).parse_rsp_body(response_body)
