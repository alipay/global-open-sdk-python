...
class AmsApiV1PaymentsCapturePost200Response(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AmsApiV1PaymentsCapturePost200Response."""
    ...
    def capture_amount(self):
        """Gets the capture_amount of this AmsApiV1PaymentsCapturePost200Response."""
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(
            AmsApiV1PaymentsCapturePost200Response, self
        ).parse_rsp_body(response_body)
