...
class AlipayPayQueryResponse(AlipayResponse):
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "payment_result_code")
            and self.payment_result_code is not None
        ):
            params["paymentResultCode"] = self.payment_result_code
        if (
            hasattr(self, "payment_result_message")
            and self.payment_result_message is not None
        ):
        ...
        if (
            hasattr(self, "actual_payment_amount")
            and self.actual_payment_amount is not None
        ):
        ...
        if (
            hasattr(self, "payment_create_time")
            and self.payment_create_time is not None
        ):
        ...
        if (
            ...
            and self.non_guarantee_coupon_amount is not None
        ):
        ...
        if (
            hasattr(self, "redirect_action_form")
            and self.redirect_action_form is not None
        ):
        ...
        if (
            hasattr(self, "acquirer_reference_no")
            and self.acquirer_reference_no is not None
        ):
        ...
        if (
            hasattr(self, "customs_declaration_amount")
            and self.customs_declaration_amount is not None
        ):
            params["customsDeclarationAmount"] = self.customs_declaration_amount
        if (
            hasattr(self, "gross_settlement_amount")
        ...
        if (
            hasattr(self, "payment_result_info")
            and self.payment_result_info is not None
        ):
        ...
        if (
            hasattr(self, "earliest_settlement_time")
            and self.earliest_settlement_time is not None
        ):
            params["earliestSettlementTime"] = self.earliest_settlement_time
        if (
            hasattr(self, "payment_method_type")
            and self.payment_method_type is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "paymentStatus" in response_body:
            payment_status_temp = TransactionStatusType.value_of(
        ...
        if "actualPaymentAmount" in response_body:
            ...
            self.__actual_payment_amount.parse_rsp_body(
                response_body["actualPaymentAmount"]
            )
        ...
        if "nonGuaranteeCouponAmount" in response_body:
            ...
            self.__non_guarantee_coupon_amount.parse_rsp_body(
                response_body["nonGuaranteeCouponAmount"]
            )
        ...
        if "redirectActionForm" in response_body:
            ...
            self.__redirect_action_form.parse_rsp_body(
                response_body["redirectActionForm"]
            )
        ...
        if "customsDeclarationAmount" in response_body:
            ...
            self.__customs_declaration_amount.parse_rsp_body(
                response_body["customsDeclarationAmount"]
            )
        if "grossSettlementAmount" in response_body:
            self.__gross_settlement_amount = Amount()
            self.__gross_settlement_amount.parse_rsp_body(
                response_body["grossSettlementAmount"]
            )
        ...
        if "paymentResultInfo" in response_body:
            ...
            self.__payment_result_info.parse_rsp_body(
                response_body["paymentResultInfo"]
            )
