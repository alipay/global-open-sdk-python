...
class AlipayCreatePayoutResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayCreatePayoutResponse."""
    ...
    def transfer_id(self):
        """
        The unique ID assigned by Antom to identify a payout.  This parameter is returned when the value of result.resultStatus is U.   More information:  Maximum length: 64 characters
        """
    ...
    def transfer_request_id(self):
        """
        The unique ID assigned by the marketplace to identify a payout request.  This parameter is returned when the value of result.resultStatus is U.   More information:  Maximum length: 64 characters
        """
    ...
    def transfer_from_detail(self):
        """Gets the transfer_from_detail of this AlipayCreatePayoutResponse."""
    ...
    def transfer_to_detail(self):
        """Gets the transfer_to_detail of this AlipayCreatePayoutResponse."""
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "transfer_request_id")
            and self.transfer_request_id is not None
        ):
            params["transferRequestId"] = self.transfer_request_id
        if (
            hasattr(self, "transfer_from_detail")
            and self.transfer_from_detail is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayCreatePayoutResponse, self).parse_rsp_body(
            response_body
        )
        ...
        if "transferFromDetail" in response_body:
            ...
            self.__transfer_from_detail.parse_rsp_body(
                response_body["transferFromDetail"]
            )
