...
from com.alipay.ams.api.model.transfer_from_detail_response import TransferFromDetailResponse
from com.alipay.ams.api.model.transfer_to_detail_response import TransferToDetailResponse
...
class AlipayCreateTransferResponse(AlipayResponse):
    def __init__(self, rsp_body):
        ...
        self.__transfer_from_detail = None  # type: TransferFromDetailResponse
        self.__transfer_to_detail = None  # type: TransferToDetailResponse
    ...
    def transfer_request_id(self):
        """
        The unique ID assigned by the merchant to identify a transfer request. Note: This field is returned on demand only when the value of result.resultStatus is S.
        """
    ...
    def transfer_id(self):
        """
        The unique ID assigned by Antom to identify a transfer. Note: This field is returned on demand only when the value of result.resultStatus is S.
        """
