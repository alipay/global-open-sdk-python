...
class AlipayProductUpdateResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayProductUpdateResponse.
    ...
    def type(self):
        """
        Product type. Enum: SERVICE, GOOD. See Section 4.1.1 Create Product request for full behavioral descriptions Returned only when result.resultCode is SUCCESS.
        """
        return self.__type
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayProductUpdateResponse, self).parse_rsp_body(response_body)
