...
class AlipayCreditGrantUpdateExpiryResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayCreditGrantUpdateExpiryResponse.
    ...
    def credit_grant(self):
        """Gets the credit_grant of this AlipayCreditGrantUpdateExpiryResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayCreditGrantUpdateExpiryResponse, self).parse_rsp_body(response_body)
