...
class AlipayCreditGrantCreateResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayCreditGrantCreateResponse.
    ...
    def credit_grant(self):
        """Gets the credit_grant of this AlipayCreditGrantCreateResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayCreditGrantCreateResponse, self).parse_rsp_body(response_body)
