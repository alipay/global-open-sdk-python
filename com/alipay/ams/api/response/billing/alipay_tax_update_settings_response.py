...
class AlipayTaxUpdateSettingsResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayTaxUpdateSettingsResponse.
    ...
    def head_office(self):
        """Gets the head_office of this AlipayTaxUpdateSettingsResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayTaxUpdateSettingsResponse, self).parse_rsp_body(response_body)
