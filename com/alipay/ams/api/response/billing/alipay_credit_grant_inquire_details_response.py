...
class AlipayCreditGrantInquireDetailsResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayCreditGrantInquireDetailsResponse.
    ...
    def credit_grant(self):
        """Gets the credit_grant of this AlipayCreditGrantInquireDetailsResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayCreditGrantInquireDetailsResponse, self).parse_rsp_body(response_body)
