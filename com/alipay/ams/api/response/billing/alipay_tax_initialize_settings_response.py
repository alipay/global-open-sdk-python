...
class AlipayTaxInitializeSettingsResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayTaxInitializeSettingsResponse.
    ...
    def head_office(self):
        """Gets the head_office of this AlipayTaxInitializeSettingsResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayTaxInitializeSettingsResponse, self).parse_rsp_body(response_body)
