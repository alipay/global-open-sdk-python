...
class AlipayCreditNoteInquireDetailsResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayCreditNoteInquireDetailsResponse.
    ...
    def total_amount(self):
        """Gets the total_amount of this AlipayCreditNoteInquireDetailsResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayCreditNoteInquireDetailsResponse, self).parse_rsp_body(response_body)
