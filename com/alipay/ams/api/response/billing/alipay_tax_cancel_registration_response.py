...
class AlipayTaxCancelRegistrationResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayTaxCancelRegistrationResponse.
    ...
    def jurisdiction(self):
        """Gets the jurisdiction of this AlipayTaxCancelRegistrationResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayTaxCancelRegistrationResponse, self).parse_rsp_body(response_body)
