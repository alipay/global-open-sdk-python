...
class AlipayTaxRegisterResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayTaxRegisterResponse.
    ...
    def jurisdiction(self):
        """Gets the jurisdiction of this AlipayTaxRegisterResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayTaxRegisterResponse, self).parse_rsp_body(response_body)
