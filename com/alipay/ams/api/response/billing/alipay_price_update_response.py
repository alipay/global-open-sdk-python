...
class AlipayPriceUpdateResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayPriceUpdateResponse.
    ...
    def price_id(self):
        """
        Updated price ID Returned only when result.resultCode is SUCCESS.
        """
    ...
    def unit_amount(self):
        """Gets the unit_amount of this AlipayPriceUpdateResponse.
    ...
    @property
    def recurring(self):
        """Gets the recurring of this AlipayPriceUpdateResponse.
    ...
    def metadata(self):
        """
        Custom metadata encoded as a JSON object string. The returned value reflects the full stored metadata after replacement. PII must not be stored. Returned only when result.resultCode is SUCCESS.
        """
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayPriceUpdateResponse, self).parse_rsp_body(response_body)
