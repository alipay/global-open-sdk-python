...
class AlipayPriceInquireDetailsResponse(AlipayResponse):
    ...
    @property
    def result(self):
        """Gets the result of this AlipayPriceInquireDetailsResponse.
    ...
    def unit_amount(self):
        """Gets the unit_amount of this AlipayPriceInquireDetailsResponse.
    ...
    @property
    def recurring(self):
        """Gets the recurring of this AlipayPriceInquireDetailsResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayPriceInquireDetailsResponse, self).parse_rsp_body(response_body)
