import json
from com.alipay.ams.api.model.alipay_inquire_card_sensitive_info_response_authorization_control import AlipayInquireCardSensitiveInfoResponseAuthorizationControl
...
class AlipayInquireCardSensitiveInfoResponse(AlipayResponse):
    def __init__(self, rsp_body):
        ...
        self.__authorization_control = None  # type: AlipayInquireCardSensitiveInfoResponseAuthorizationControl
    ...
    def parse_rsp_body(self, response_body):
        ...
        if 'authorizationControl' in response_body:
            self.__authorization_control = AlipayInquireCardSensitiveInfoResponseAuthorizationControl()
