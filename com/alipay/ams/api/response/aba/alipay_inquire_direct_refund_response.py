...
class AlipayInquireDirectRefundResponse(AlipayResponse):
    ...
    def refund_status(self):
        """Gets the refund_status of this AlipayInquireDirectRefundResponse.
    ...
    def refund_from_method(self):
        """Gets the refund_from_method of this AlipayInquireDirectRefundResponse.
    ...
    def refund_to_amount(self):
        """Gets the refund_to_amount of this AlipayInquireDirectRefundResponse.
    ...
    def refund_from_amount(self):
        """Gets the refund_from_amount of this AlipayInquireDirectRefundResponse.
    ...
    @property
    def result(self):
        """Gets the result of this AlipayInquireDirectRefundResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayInquireDirectRefundResponse, self).parse_rsp_body(response_body)
