...
class AlipayCreateDirectRefundResponse(AlipayResponse):
    ...
    def refund_from_method(self):
        """Gets the refund_from_method of this AlipayCreateDirectRefundResponse.
    ...
    def refund_from_amount(self):
        """Gets the refund_from_amount of this AlipayCreateDirectRefundResponse.
    ...
    def refund_to_amount(self):
        """Gets the refund_to_amount of this AlipayCreateDirectRefundResponse.
    ...
    @property
    def result(self):
        """Gets the result of this AlipayCreateDirectRefundResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayCreateDirectRefundResponse, self).parse_rsp_body(response_body)
