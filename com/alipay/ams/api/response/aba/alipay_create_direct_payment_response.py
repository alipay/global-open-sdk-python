...
class AlipayCreateDirectPaymentResponse(AlipayResponse):
    ...
    @property
    def payment_id(self):
        """Gets the payment_id of this AlipayCreateDirectPaymentResponse.
    ...
    def payment_request_id(self):
        """Gets the payment_request_id of this AlipayCreateDirectPaymentResponse.
    ...
    def pay_to_method(self):
        """Gets the pay_to_method of this AlipayCreateDirectPaymentResponse.
    ...
    def pay_from_amount(self):
        """Gets the pay_from_amount of this AlipayCreateDirectPaymentResponse.
    ...
    def pay_to_amount(self):
        """Gets the pay_to_amount of this AlipayCreateDirectPaymentResponse.
    ...
    def payment_time(self):
        """Gets the payment_time of this AlipayCreateDirectPaymentResponse.
    ...
    @property
    def result(self):
        """Gets the result of this AlipayCreateDirectPaymentResponse.
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayCreateDirectPaymentResponse, self).parse_rsp_body(response_body)
