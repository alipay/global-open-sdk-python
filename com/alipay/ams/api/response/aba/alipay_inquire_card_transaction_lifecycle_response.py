...
from com.alipay.ams.api.model.card_transaction_lifecycle import CardTransactionLifecycle



from com.alipay.ams.api.response.alipay_response import AlipayResponse

class AlipayInquireCardTransactionLifecycleResponse(AlipayResponse):
    def __init__(self, rsp_body):
        super(AlipayResponse, self).__init__() 

        self.__result = None  # type: Result
        self.__lifecycles = None  # type: [CardTransactionLifecycle]
    ...
    @property
    def result(self):
        """Gets the result of this AlipayInquireCardTransactionLifecycleResponse.
    ...
    def lifecycles(self):
        ...
        """
        return self.__lifecycles

    @lifecycles.setter
    def lifecycles(self, value):
        self.__lifecycles = value
    @property
    ...
    def to_ams_dict(self):
        ...
        if hasattr(self, "lifecycles") and self.lifecycles is not None:
            params['lifecycles'] = self.lifecycles
    ...
    def parse_rsp_body(self, response_body):
        response_body = super(AlipayInquireCardTransactionLifecycleResponse, self).parse_rsp_body(response_body)
        if 'result' in response_body:
            self.__result = Result()
            self.__result.parse_rsp_body(response_body['result'])
        if 'lifecycles' in response_body:
            self.__lifecycles = []
            for item in response_body['lifecycles']:
                obj = CardTransactionLifecycle()
                obj.parse_rsp_body(item)
                self.__lifecycles.append(obj)
