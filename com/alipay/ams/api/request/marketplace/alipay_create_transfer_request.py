...
class AlipayCreateTransferRequest(AlipayRequest):
    def __init__(self):
        super(AlipayCreateTransferRequest, self).__init__(
    ...
    def transfer_from_detail(self):
        """Gets the transfer_from_detail of this AlipayCreateTransferRequest."""
    ...
    def transfer_to_detail(self):
        """Gets the transfer_to_detail of this AlipayCreateTransferRequest."""
