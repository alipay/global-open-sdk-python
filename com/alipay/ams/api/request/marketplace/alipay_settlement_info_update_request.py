...
class AlipaySettlementInfoUpdateRequest(AlipayRequest):
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "reference_merchant_id")
            and self.reference_merchant_id is not None
        ):
        ...
        if (
            hasattr(self, "settlement_bank_account")
            and self.settlement_bank_account is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "settlementBankAccount" in response_body:
            ...
            self.__settlement_bank_account.parse_rsp_body(
                response_body["settlementBankAccount"]
            )
