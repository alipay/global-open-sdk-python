...
class AlipaySubscriptionChangeRequest(AlipayRequest):
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "subscription_change_request_id")
            and self.subscription_change_request_id is not None
        ):
        ...
        if (
            hasattr(self, "payment_amount_difference")
            and self.payment_amount_difference is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "subscriptionChangeRequestId" in response_body:
            self.__subscription_change_request_id = response_body[
        ...
        if "paymentAmountDifference" in response_body:
            ...
            self.__payment_amount_difference.parse_rsp_body(
                response_body["paymentAmountDifference"]
            )
