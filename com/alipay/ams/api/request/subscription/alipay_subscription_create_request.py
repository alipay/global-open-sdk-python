...
class AlipaySubscriptionCreateRequest(AlipayRequest):
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "max_accumulate_amount")
            and self.max_accumulate_amount is not None
        ):
            params["maxAccumulateAmount"] = self.max_accumulate_amount
        if (
            hasattr(self, "subscription_request_id")
            and self.subscription_request_id is not None
        ):
        ...
        if (
            hasattr(self, "subscription_redirect_url")
            and self.subscription_redirect_url is not None
        ):
            params["subscriptionRedirectUrl"] = self.subscription_redirect_url
        if (
            hasattr(self, "subscription_start_time")
            and self.subscription_start_time is not None
        ):
        ...
        if (
            hasattr(self, "subscription_expiry_time")
            and self.subscription_expiry_time is not None
        ):
        ...
        if (
            hasattr(self, "subscription_notification_url")
            and self.subscription_notification_url is not None
        ):
            params["subscriptionNotificationUrl"] = self.subscription_notification_url
        if (
            hasattr(self, "payment_notification_url")
            and self.payment_notification_url is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "maxAccumulateAmount" in response_body:
            ...
            self.__max_accumulate_amount.parse_rsp_body(
                response_body["maxAccumulateAmount"]
            )
        ...
        if "subscriptionNotificationUrl" in response_body:
            self.__subscription_notification_url = response_body[
