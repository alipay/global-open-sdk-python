...
class CreateDirectPaymentRequest(AlipayRequest):
    def __init__(self):
        super(CreateDirectPaymentRequest, self).__init__("/ams/aba/funds/createDirectPayment") 
    ...
    def payment_request_id(self):
        """Gets the payment_request_id of this CreateDirectPaymentRequest.
    ...
    @property
    def memo(self):
        """Gets the memo of this CreateDirectPaymentRequest.
    ...
    @property
    def remark(self):
        """Gets the remark of this CreateDirectPaymentRequest.
    ...
    @property
    def order(self):
        """Gets the order of this CreateDirectPaymentRequest.
    ...
    def payment_notify_url(self):
        """Gets the payment_notify_url of this CreateDirectPaymentRequest.
    ...
    def pay_to_method(self):
        """Gets the pay_to_method of this CreateDirectPaymentRequest.
    ...
    def pay_to_amount(self):
        """Gets the pay_to_amount of this CreateDirectPaymentRequest.
    ...
    def pay_from_amount(self):
        """Gets the pay_from_amount of this CreateDirectPaymentRequest.
