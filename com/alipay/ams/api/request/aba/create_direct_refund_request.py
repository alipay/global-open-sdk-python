...
class CreateDirectRefundRequest(AlipayRequest):
    def __init__(self):
        super(CreateDirectRefundRequest, self).__init__("/ams/aba/funds/createDirectRefund") 
    ...
    def refund_from_method(self):
        """Gets the refund_from_method of this CreateDirectRefundRequest.
    ...
    def refund_from_amount(self):
        """Gets the refund_from_amount of this CreateDirectRefundRequest.
