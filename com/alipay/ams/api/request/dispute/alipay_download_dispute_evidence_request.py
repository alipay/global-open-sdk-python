...
class AlipayDownloadDisputeEvidenceRequest(AlipayRequest):
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "dispute_evidence_type")
            and self.dispute_evidence_type is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "disputeEvidenceType" in response_body:
            dispute_evidence_type_temp = DisputeEvidenceType.value_of(
                response_body["disputeEvidenceType"]
            )
