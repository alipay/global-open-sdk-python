...
class AlipayRefundRequest(AlipayRequest):
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "refund_to_bank_info")
            and self.refund_to_bank_info is not None
        ):
        ...
        if (
            hasattr(self, "reference_refund_id")
            and self.reference_refund_id is not None
        ):
        ...
        if (
            hasattr(self, "refund_source_account_no")
            and self.refund_source_account_no is not None
        ):
