...
class AlipayPayRequest(AlipayRequest):
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "payment_verification_data")
            and self.payment_verification_data is not None
        ):
        ...
        if (
            hasattr(self, "dual_offline_payment")
            and self.dual_offline_payment is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "paymentVerificationData" in response_body:
            ...
            self.__payment_verification_data.parse_rsp_body(
                response_body["paymentVerificationData"]
            )
