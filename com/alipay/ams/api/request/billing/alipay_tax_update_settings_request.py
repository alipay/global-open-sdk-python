...
class AlipayTaxUpdateSettingsRequest(AlipayRequest):
    def __init__(self):
        super(AlipayTaxUpdateSettingsRequest, self).__init__("/ams/api/v1/tax/updateSettings") 

        self.__settings_update_request_id = None  # type: str
    ...
    @property
    def settings_update_request_id(self):
        """
        The unique ID assigned by a merchant to identify a tax settings update request. Maximum length: 64 characters. Note: See documentation for details.
        """
        return self.__settings_update_request_id

    @settings_update_request_id.setter
    def settings_update_request_id(self, value):
        self.__settings_update_request_id = value
    @property
    ...
    def head_office(self):
        """Gets the head_office of this AlipayTaxUpdateSettingsRequest.
    ...
    def to_ams_dict(self):
        params = dict()
        if hasattr(self, "settings_update_request_id") and self.settings_update_request_id is not None:
            params['settingsUpdateRequestId'] = self.settings_update_request_id
    ...
    def parse_rsp_body(self, response_body):
        ...
        if 'settingsUpdateRequestId' in response_body:
            self.__settings_update_request_id = response_body['settingsUpdateRequestId']
