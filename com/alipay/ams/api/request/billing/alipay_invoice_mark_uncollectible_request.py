...
class AlipayInvoiceMarkUncollectibleRequest(AlipayRequest):
    def __init__(self):
        super(AlipayInvoiceMarkUncollectibleRequest, self).__init__("/ams/api/v1/billing/invoice/markUncollectible") 
