...
class RiskData:
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "card_verification_result")
            and self.card_verification_result is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "cardVerificationResult" in response_body:
            ...
            self.__card_verification_result.parse_rsp_body(
                response_body["cardVerificationResult"]
            )
