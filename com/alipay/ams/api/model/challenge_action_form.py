...
from com.alipay.ams.api.model.challenge_trigger_source_type import (
...
class ChallengeActionForm:
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "challenge_render_value")
            and self.challenge_render_value is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "triggerSource" in response_body:
            trigger_source_temp = ChallengeTriggerSourceType.value_of(
                response_body["triggerSource"]
            )
