...
class CreateDirectRefundResponses:
    def __init__(self):
    ...
    def refund_from_method(self):
        """Gets the refund_from_method of this CreateDirectRefundResponses.
    ...
    def refund_from_amount(self):
        """Gets the refund_from_amount of this CreateDirectRefundResponses.
    ...
    def refund_to_amount(self):
        """Gets the refund_to_amount of this CreateDirectRefundResponses.
    ...
    @property
    def result(self):
        """Gets the result of this CreateDirectRefundResponses.
