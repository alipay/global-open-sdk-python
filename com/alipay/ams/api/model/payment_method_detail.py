...
from com.alipay.ams.api.model.external_payment_method_detail import (
    ExternalPaymentMethodDetail,
)
from com.alipay.ams.api.model.discount_payment_method_detail import (
    DiscountPaymentMethodDetail,
)
from com.alipay.ams.api.model.coupon_payment_method_detail import (
...
class PaymentMethodDetail:
    ...
    def to_ams_dict(self):
        params = dict()
        if (
            hasattr(self, "payment_method_detail_type")
            and self.payment_method_detail_type is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "paymentMethodDetailType" in response_body:
            payment_method_detail_type_temp = PaymentMethodDetailType.value_of(
                response_body["paymentMethodDetailType"]
            )
