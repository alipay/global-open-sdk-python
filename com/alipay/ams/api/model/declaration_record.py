...
class DeclarationRecord(object):
    ...
    def to_ams_dict(self):
        ...
        if self.customs_declaration_result_code is not None:
            params["customsDeclarationResultCode"] = (
                self.customs_declaration_result_code
            )
        if self.customs_declaration_result_desc is not None:
            params["customsDeclarationResultDesc"] = (
                self.customs_declaration_result_desc
            )
        if self.customs_declaration_return_time is not None:
            params["customsDeclarationReturnTime"] = (
                self.customs_declaration_return_time
            )
        return params
    ...
    def parse_rsp_body(self, declaration_record_body):
        ...
        if "declarationRequestId" in declaration_record_body:
            self.declaration_request_id = declaration_record_body[
        ...
        if "merchantCustomsInfo" in declaration_record_body:
            ...
            self.merchant_customs_info.parse_rsp_body(
                declaration_record_body["merchantCustomsInfo"]
            )
        if "declarationAmount" in declaration_record_body:
            self.declaration_amount = Amount()
            self.declaration_amount.parse_rsp_body(
                declaration_record_body["declarationAmount"]
            )
        ...
        if "declarationRequestStatus" in declaration_record_body:
            self.declaration_request_status = declaration_record_body[
        ...
        if "customsDeclarationResultCode" in declaration_record_body:
            self.customs_declaration_result_code = declaration_record_body[
                "customsDeclarationResultCode"
            ]
        if "customsDeclarationResultDesc" in declaration_record_body:
            self.customs_declaration_result_desc = declaration_record_body[
                "customsDeclarationResultDesc"
            ]
        if "customsDeclarationReturnTime" in declaration_record_body:
            self.customs_declaration_return_time = declaration_record_body[
