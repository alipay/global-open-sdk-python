...
class ThreeDSResult:
    ...
    def to_ams_dict(self):
        ...
        if hasattr(self, "xid") and self.xid is not None:
            params["xid"] = self.xid
        if (
            hasattr(self, "three_d_stransaction_status_reason")
            and self.three_d_stransaction_status_reason is not None
        ):
            params["threeDStransactionStatusReason"] = (
                self.three_d_stransaction_status_reason
            )
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "threeDStransactionStatusReason" in response_body:
            self.__three_d_stransaction_status_reason = response_body[
