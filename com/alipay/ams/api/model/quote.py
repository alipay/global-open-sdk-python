...
class Quote:
    ...
    def quote_id(self):
        """
        The unique ID that is assigned by Alipay to identify an exchange rate.    More information:  Maximum length: 64 characters
        """
    ...
    def quote_currency_pair(self):
        """
        The exchange rate between settlement currency and transaction currency. Two currencies are separated with a slash and use the 3-letter ISO-4217 currency code.    More information:  Maximum length: 16 characters
        """
