...
class InvoiceItem:
    ...
    def price_id(self):
        """
        Associated price ID if the item was generated from a price catalog entry. Omitted for items not generated from a price catalog entry.
        """
    ...
    def usage_quantity(self):
        """
        Usage quantity (for metered billing items). Precision: up to 12 integer digits and 6 decimal places. Omitted for fixed-price items.
        """
    ...
    def period_start(self):
        """
        Service period start for this line item (ISO 8601). Omitted when the item has no service period.
        """
    ...
    def proration(self):
        """
        Whether this is a proration item. &#x60;true&#x60; &#x3D; proration item generated by a mid-cycle subscription change (partial-period charge or credit); &#x60;false&#x60; &#x3D; regular full-period item. Always returned - never absent, no default.
        """
