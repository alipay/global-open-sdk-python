...
class Goods:
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "delivery_method_type")
            and self.delivery_method_type is not None
        ):
        ...
        if (
            hasattr(self, "goods_discount_amount")
            and self.goods_discount_amount is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "goodsDiscountAmount" in response_body:
            ...
            self.__goods_discount_amount.parse_rsp_body(
                response_body["goodsDiscountAmount"]
            )
