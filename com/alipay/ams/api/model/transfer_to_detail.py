...
class TransferToDetail:
    ...
    def to_ams_dict(self):
        ...
        if (
            hasattr(self, "transfer_to_currency")
            and self.transfer_to_currency is not None
        ):
        ...
        if (
            hasattr(self, "actual_transfer_to_amount")
            and self.actual_transfer_to_amount is not None
        ):
        ...
        if (
            hasattr(self, "transfer_notify_url")
            and self.transfer_notify_url is not None
        ):
    ...
    def parse_rsp_body(self, response_body):
        ...
        if "actualTransferToAmount" in response_body:
            ...
            self.__actual_transfer_to_amount.parse_rsp_body(
                response_body["actualTransferToAmount"]
            )
