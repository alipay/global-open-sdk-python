...
class Env:
    ...
    def device_token_id(self):
        """Gets the device_token_id of this Env.
    ...
    def extend_info(self):
        """Gets the extend_info of this Env.
    ...
    def color_depth(self):
        """Gets the color_depth of this Env.
    ...
    def screen_height(self):
        """Gets the screen_height of this Env.
    ...
    def screen_width(self):
        """Gets the screen_width of this Env.
    ...
    def time_zone_offset(self):
        """Gets the time_zone_offset of this Env.
    ...
    def device_brand(self):
        """Gets the device_brand of this Env.
    ...
    def device_model(self):
        """Gets the device_model of this Env.
    ...
    def device_language(self):
        """
        The language of the device where the user places an order.  Note: Specify this parameter if you require risk control. Providing this information helps to identify black-market behavior.    More information:  Maximum length: 32 characters
        """
    ...
    def device_id(self):
        """
        The unique ID of the device the user places an order with.  Note: Specify this parameter if you require risk control. This parameter can be used to build a trusted relationship between users and commonly used devices, thereby reducing risk control interruptions and increasing the payment success rate.    More information:  Maximum length: 64 characters
        """
