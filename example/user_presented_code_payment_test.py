...
from com.alipay.ams.api.request.pay.user_presented_code_payment_request import (
    UserPresentedCodePaymentRequest,
)
...
class UserPresentedCodePaymentRequestTest(unittest.TestCase):
    ...
    def test_upcp(self):
        ...
        upcpReq = UserPresentedCodePaymentRequest(
            payment_request_id=int(time.time()),
            order=order,
            currency="USD",
            amount_in_cents=1231,
            payment_code="28888888888888888888",
