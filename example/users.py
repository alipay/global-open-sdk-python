...
from com.alipay.ams.api.request.users.alipay_user_query_info_request import AlipayUserQueryInfoRequest
from com.alipay.ams.api.response.users.alipay_user_query_info_response import AlipayUserQueryInfoResponse
from com.alipay.ams.api.request.users.alipay_init_authentication_request import AlipayInitAuthenticationRequest
from com.alipay.ams.api.response.users.alipay_init_authentication_response import AlipayInitAuthenticationResponse
from com.alipay.ams.api.request.users.alipay_verify_authentication_request import AlipayVerifyAuthenticationRequest
from com.alipay.ams.api.response.users.alipay_verify_authentication_response import AlipayVerifyAuthenticationResponse
from com.alipay.ams.api.model.authentication_type import AuthenticationType
from com.alipay.ams.api.model.authentication_channel_type import AuthenticationChannelType
...
def user_query_info():
    ...
    if alipay_user_query_info_response.result.result_status.name != ResultStatusType.F.name:
...
def init_authentication():
    ...
    alipay_init_authentication_request.user_identity_type = UserIdentityType.WALLET_TOKEN
    alipay_init_authentication_request.user_identity_value = "2020042910435415881282340824710273532915573saFBMrdXVH"
    ...
    if alipay_init_authentication_response.result.result_status.name != ResultStatusType.F.name:
...
def verify_authentication():
    ...
    if alipay_verify_authentication_response.result.result_status.name != ResultStatusType.F.name:
