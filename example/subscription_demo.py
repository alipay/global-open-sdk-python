...
from com.alipay.ams.api.request.subscription.alipay_subscription_cancel_request import (
    AlipaySubscriptionCancelRequest,
)
from com.alipay.ams.api.request.subscription.alipay_subscription_change_request import (
    AlipaySubscriptionChangeRequest,
)
from com.alipay.ams.api.request.subscription.alipay_subscription_create_request import (
...
def subscriptionsCreate():
    ...
    alipay_subscription_create_request.payment_notification_url = (
    ...
    alipay_subscription_create_request.subscription_start_time = (
        "2024-10-16T00:00:00+08:00"
    )
    alipay_subscription_create_request.subscription_end_time = (
        "2024-10-17T17:00:00+08:00"
    )
    alipay_subscription_create_request.subscription_expiry_time = (
        "2024-10-18T00:00:00+08:00"
    )
    alipay_subscription_create_request.subscription_notification_url = (
        "https://www.yourNotifyUrl.com"
    )
    ...
    alipay_subscription_create_request.subscription_redirect_url = (
...
def subscriptionsChange(subscriptionId):
    ...
    alipay_subscription_change_request.subscription_change_request_id = str(
        uuid.uuid4()
    )
    ...
    alipay_subscription_change_request.subscription_start_time = (
        "2024-10-16T00:00:00+08:00"
    )
    alipay_subscription_change_request.subscription_end_time = (
        "2024-10-17T17:00:00+08:00"
    )
    order_info = OrderInfo()
    order_info.order_amount = Amount("HKD", "100")
