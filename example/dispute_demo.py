...
from com.alipay.ams.api.request.dispute.alipay_accept_dispute_request import (
...
from com.alipay.ams.api.request.dispute.alipay_supply_defense_document_request import (
    AlipaySupplyDefenseDocumentRequest,
)
from com.alipay.ams.api.response.dispute.alipay_accept_dispute_response import (
...
def downloadDisputeEvidence(disputeId):
    ...
    alipay_download_dispute_evidence_request.dispute_evidence_type = (
